...
const buildDetailedSinhalaText = (field: keyof Prediction, rashiName: string) => {
  const detailed: Record<keyof Prediction, string> = {
    characterTraits: `${rashiName} ලග්නය ඇති ඔබට නායකත්ව ගුණ, ඉක්මන් තීරණ ගැනීමේ හැකියාව සහ තම වැඩේට කැපවීමක් ඇත. නමුත් කලාතුරකින් ඉක්මන් ප්‍රතිචාර හෝ හදිසි තීරණ නිසා වරදවා අවබෝධ ඇතිවිය හැකි බැවින් සන්සුන්ව කටයුතු කිරීම වඩා සුදුසුය.`,
    health: `මෙම කාලයේ ඔබේ ශරීර ශක්තිය සහ මානසික ශක්තිය සමබරව තබාගැනීම වැදගත්ය. නිදාගැනීම, ජලය පානය කිරීම සහ අධික පීඩනයෙන් වැළකීම ඔබට හොඳ ප්‍රතිඵල දෙනු ඇත.`,
    career: `රැකියාව සහ දියුණුව පැත්තෙන් සැලකිලිමත්ව ඉදිරියට යා හැකි කාලයක්. සැලසුමකට අනුව වැඩ කිරීම, හොඳ සන්නිවේදනය සහ වගකීම් නිසි පරිදි ඉටු කිරීම ඔබට වාසිදායක වේ.`,
    wealth: `මුදල් පැත්තෙන් මේ කාලය මධ්‍යස්ථ නමුත් කළමනාකරණය කළ හැකි කාලයකි. අනවශ්‍ය වියදම් අඩු කර ඉතිරි කිරීම සහ වගකීම් පරීක්ෂා කර තීරණ ගැනීම වඩා හොඳයි.`,
    love: `ආදරය සහ සම්බන්ධතා පැත්තෙන් සන්සුන් කතාබහ ඉතා වැදගත් වේ. අහංකාරය, නිරවද්‍ය නොවන සැක සහ නිහඬභාවය නිසා වරදවා අවබෝධ ඇතිවිය හැකි බැවින් පැහැදිලිව අදහස් පළ කරන්න.`,
    education: `ඉගෙනීමේ කටයුතු සඳහා අවධානය, පුරුද්ද සහ සැලසුම ඉතා වැදගත්. දිනපතා කුඩා ඉලක්ක තබා වැඩ කළහොත් හොඳ ප්‍රගතියක් දැකගත හැක.`,
    general: `සමස්තයෙන් බලන විට මෙය මිශ්‍ර නමුත් හොඳින් පාලනය කළ හැකි කාලයකි. ඉවසීම, නියමිත වේලාවට වැඩ කිරීම සහ සන්සුන් සිතුවිලි ඔබට වාසිදායක වේ.`,
    mahaDasha: `ප්‍රධාන දශා කාලයේ බලපෑම් ස්ථාවර ලෙස පෙනේ. ඉක්මන් විශාල වෙනසකට වඩා ක්‍රමයෙන් දියුණුව සහ පදනමක් ශක්තිමත් කිරීම සිදුවන කාලයකි.`,
    antaraDasha: `අතුරු දශා බලපෑම නිසා කෙටි කාලීන පීඩනයක් හෝ සිතිවිලි අවුල් වීමක් ඇතිවිය හැක. එහෙත් සන්සුන්ව ක්‍රියා කළහොත් තත්වය හොඳින් පාලනය කළ හැක.`,
    planetaryPositions: `දැනට ග්‍රහ පිහිටීම් අනුව සමබරතාව, ඉවසීම සහ පෞද්ගලික වගකීම් ගැන වැඩි අවධානයක් අවශ්‍ය බව පෙනේ. ප්‍රමාද නොකර නිසි කටයුතු සිදු කිරීම වඩා හොඳයි.`,
    adviceRemedies: `ඉක්මනින් අවදි වීම, සන්සුන් සිතුවිලි තබාගැනීම, අනවශ්‍ය ගැටුම් වලින් වැළකීම සහ දිනපතා කුඩා හොඳ පුරුදු අනුගමනය කිරීම ඔබට යහපත් බලපෑම් වැඩි කරයි.`,
    remedies: ''
  };
